<script lang="ts">
  ...
  const isRunning = $derived(serverStatus === 'running' || $serverInfo?.reachable === true)
  ...
  <div class="py-4 flex items-center justify-between">
    <div>
      ...
      <div class="text-[11px] opacity-20 mt-0.5">
        {$i18n.t('settings.openwebui.notInstalledDesc')}
      </div>
    </div>
    <button
  ...
  <div class="flex flex-col divide-y divide-white/[0.04]">
      ...
      <div class="flex items-center justify-between mb-3">
        <div>
          ...
          <div class="text-[11px] opacity-25 mt-0.5">
            ...
            {/if}{$i18n.t('settings.openwebui.localInstance')}
          </div>
        </div>
        <div class="flex items-center gap-1.5">
          ...
          {:else}
            ...
            <span class="text-[12px] opacity-30 capitalize"
              >{serverStatus ?? $i18n.t('common.unknown')}</span
            >
          {/if}
        </div>
      </div>
    ...
    {#if isRunning}
      <div class="py-4">
        <div class="text-[13px] opacity-70 mb-3">
          {$i18n.t('settings.openwebui.runningInstance')}
        </div>
        <div class="flex flex-col gap-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              onclick={() => window.open($serverInfo?.url ?? 'http://127.0.0.1:8080')}
              >{$serverInfo?.url ?? 'http://127.0.0.1:8080'}</button
            >
          </div>
          {#if serverPid}
            <div class="flex items-center justify-between">
    ...
    <div class="py-4 flex items-center justify-between">
      <div>
        ...
        <div class="text-[11px] opacity-25 mt-0.5">
          {$i18n.t('settings.openwebui.serverPortDesc')}
        </div>
      </div>
      <input
        type="number"
    ...
    <div class="py-4 flex items-center justify-between">
      <div>
        <div class="text-[13px] opacity-70">
          {$i18n.t('settings.openwebui.serveOnLocalNetwork')}
        </div>
        <div class="text-[11px] opacity-25 mt-0.5">
    ...
    <div class="py-4 flex items-center justify-between gap-4">
      <div class="shrink-0">
        ...
        <div class="text-[11px] opacity-25 mt-0.5">
          {$i18n.t('settings.openwebui.dataLocationDesc')}
        </div>
      </div>
    ...
    <div class="py-4 flex items-center justify-between">
      <div>
        ...
        <div class="text-[11px] opacity-25 mt-0.5">
          {$i18n.t('settings.openwebui.uninstallDesc')}
        </div>
      </div>
      <button
